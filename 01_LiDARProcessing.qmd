...
# Load the LAS tiles
lidar_tiles <- readLAScatalog(tile_dir, chunk_size = 35, chunk_buffer = 0)
...
lidar_clean <- readLAScatalog(clean_dir, chunk_buffer = 1)
...
writeRaster(dem_albers, file.path(terrain_dir, "dem.tif"))
